...
export const AutoBackupSlots = [
  {
    ...
    intervalStr: () => `${formatInt(2)} seconds`,
    interval: 2,
  },
  {
    id: 2,
    type: BACKUP_SLOT_TYPE.ONLINE,
    intervalStr: () => `${formatInt(15)} seconds`,
    interval: 15,
  },
  {
    id: 3,
  ...
  },
  {
    id: 4,
    type: BACKUP_SLOT_TYPE.ONLINE,
    intervalStr: () => `${formatInt(90)} seconds`,
    interval: 90,
  },
  {
    id: 5,
...
export const GameStorage = {
  ...
  saveToBackupCore(backupSlot, backupTimer) {
  ...
  saveToBackup(backupSlot, backupTimer) {
    ...
    if (backupSlot <= 4 && Math.random() <= chance) {
      ...
      this.saveToBackupCore(backupSlot, backupTimer);
    }
  },
