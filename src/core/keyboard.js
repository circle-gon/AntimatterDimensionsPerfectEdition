...
export class GameKeyboard {
  ...
  static bind(key, callback, type) {
    Mousetrap.bind(key, () => GameUI.notify.error("We're sorry but hotkeys aren't supported"), type);
  }

  static bindRepeatable(key, callback) {
    this._bindSpin(key, () => GameUI.notify.error("We're sorry but hotkeys aren't supported"));
  }
